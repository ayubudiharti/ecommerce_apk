...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2022 at 07:48 AM
...
INSERT INTO `konfirmasi` (`id`, `id_chart`, `id_user`, `status`) VALUES
(2, 14, 13, '0');
...
(30, 5, 'figura', '<p>figura minimalis ekonomis</p>\r\n', 'figura', 1, 'laptop.jpg', '2022-06-21', 1);
...
--
ALTER TABLE `konfirmasi`
  ADD CONSTRAINT `chart` FOREIGN KEY (`id_chart`) REFERENCES `cart` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
